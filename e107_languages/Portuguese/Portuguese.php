...
|        Last Modified: 2017/08/19 19:00:15
|
|        $Author: Ricardo $
+---------------------------------------------------------------+
*/
...
define("CORE_LC", "pt");
define("CORE_LC2", "pt");
define("CORE_LAN1", "Erro: o tema não existe.\\n\\nMude os temas usados em preferências (área administrativa) ou envie os arquivos para o tema atual para o servidor.");
...
define("CORE_LAN6", "A proteção contra as inundações neste site foi ativada e você está avisado de que se continuar solicitando páginas você pode ser banido.");
define("CORE_LAN7", "Núcleo está a tentar restaurar as preferências a partir da cópia de segurança automática.");
define("CORE_LAN8", "Erro nas preferências do núcleo");
define("CORE_LAN9", "Núcleo não conseguiu restaurar a partir da cópia de segurança automática. Execução interrompida.");
define("CORE_LAN10", "Cookie corrompido detectado - desligado.");
...
define("LAN_NO_PERMISSIONS", "Não tem permissões para visualizar esta página.");
...
define("LAN_REQUIRED_BLANK", "Campo(s) necessário(s) estão em branco.");
