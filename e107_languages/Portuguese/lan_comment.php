...
define("COMLAN_0", "[bloqueado pelo administrador]");
...
define("COMLAN_11", "Incapaz de inserir o seu comentário no banco de dados - por favor, digite novamente deixando de fora todos os caracteres não-padrão.");
define("COMLAN_12", "Utilizador");
define("COMLAN_16", "Nome de utilizador:");
define("COMLAN_100", "Notícias");
define("COMLAN_101", "Votação");
define("COMLAN_102", "Responder para:");
define("COMLAN_103", "Artigo");
define("COMLAN_104", "Revisão");
define("COMLAN_105", "Conteúdo");
define("COMLAN_106", "Descarregar");
...
define("COMLAN_316", "Não há trackbacks para esta notícia colocada.");
define("COMLAN_317", "Trackbacks moderada");
define("COMLAN_318", "Editar comentário");
define("COMLAN_319", "edição");
define("COMLAN_320", "Atualizar comentário");
define("COMLAN_321", "aqui");
define("COMLAN_322", "para se registar");
define("COMLAN_323", "Erro!");
define("COMLAN_324", "Assunto");
define("COMLAN_325", "Re:");
define("COMLAN_326", "Responder a este");
define("COMLAN_328", "Comentários estão bloqueados");
define("COMLAN_329", "Não autorizado");
define("COMLAN_330", "IP:");
define("COMLAN_331", "Aprovação pendente");
define("COMLAN_332", "Não consegui excluir comentário");
define("COMLAN_333", "Comentário aprovado");
define("COMLAN_334", "Não foi possível aprovar o comentário");
define("COMLAN_335", "Aprovado");
define("COMLAN_336", "Por favor, escreva algo primeiro.");
define("COMLAN_337", "Atualizado com sucesso.");
define("COMLAN_400", "aprovado");
define("COMLAN_401", "bloqueado");
define("COMLAN_402", "pendente");
define("COMLAN_403", "Deixe uma mensagem...");
define("COMLAN_404", "Aprove");
define("COMLAN_TYPE_1", "notícias");
define("COMLAN_TYPE_2", "descarregar");
define("COMLAN_TYPE_3", "Perguntas Frequentes");
define("COMLAN_TYPE_4", "votação");
define("COMLAN_TYPE_5", "documentos");
define("COMLAN_TYPE_6", "rastreador de erros");
define("COMLAN_TYPE_7", "ideias");
define("COMLAN_TYPE_8", "perfil de utilizador");
define("COMLAN_TYPE_PAGE", "Conteúdo");
define("COMLAN_500", "Por favor [entre] para escrever um comentário.");
define("COMLAN_501", "Se não está ainda registado, pode [clicar aqui para se registar].");
