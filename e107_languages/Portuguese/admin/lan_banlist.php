...
define("BANLAN_5", "Digite o IP, endereço de correio electrónico ou host");
define("BANLAN_7", "Razão");
define("BANLAN_8", "Endereço de proibição");
define("BANLAN_9", "Proibir os utilizadors do site pelo endereço de correio electrónico, IP ou host");
define("BANLAN_10", "IP / Correio electrónico / razão");
define("BANLAN_11", "Auto-ban: falha de mais de 10 tentativas de login");
define("BANLAN_12", "Nota: O DNS reverso é atualmente desativado; Ele deve ser ativado para permitir que a proibição pelo host.  Banir por endereço IP e correio electrónico continuarão a funcionar normalmente.");
define("BANLAN_13", "Nota: Para proibir um nome de utilizador por utilizador, vá para a página de administração de utilizadors:");
...
define("BANLAN_48", "Excluídas [x] entradas de lista de proibição expiradas");
...
define("BANLAN_56", "IP/Correio electrónico, utilizador");
define("BANLAN_57", "Utilizador");
define("BANLAN_58", "Adicionar utilizadors à lista branca");
...
define("BANLAN_65", "Ativando esta opção permitirá que você banir utilizadores pelo hostname, então somente IP ou endereço de correio electrónico.<br>NOTA: Isso pode afetar vezes pageload em alguns hosts, ou se um servidor não está respondendo");
...
define("BANLAN_114", "Tentativas de login falha múltiplas do mesmo utilizador");
...
define("BANLAN_126", "IP / Correio electrónico");
