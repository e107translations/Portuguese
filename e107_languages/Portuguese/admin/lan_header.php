...
define("LAN_HEADER_02", "Seu servidor não permite upload de arquivos HTTP, então não será possível aos seus utilizadors para fazer upload de avatares/arquivos etc. Para corrigir este conjunto file_uploads no seu php. ini e reinicie o servidor. Se você não tem acesso ao seu contato ini seus anfitriões.");
