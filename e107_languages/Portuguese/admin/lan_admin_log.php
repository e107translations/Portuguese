...
define("RL_LAN_072", "Confirmação de correio electrónico de inscrição (ignora a configuração de classe acima)");
define("RL_LAN_073", "Login/Logout");
define("RL_LAN_075", "Mudança de nome de exibição");
define("RL_LAN_076", "Alterar senha");
define("RL_LAN_077", "Mudança de endereço de correio electrónico");
