...
define("LAN_SIGNUP_30", "Se você não deseja exibir o seu endereço de e-mail neste site, por favor, seleccione 'Sim' na opção 'Ocultar endereço de email?'.");
...
define("LAN_SIGNUP_37", "Esta fase de registo está completa. O administrador do site precisará aprovar a sua inscrição.  Uma vez que isto foi feito, você receberá um e-mail de confirmação, alertando que sua filiação foi aprovada.");
define("LAN_SIGNUP_38", "Você inseriu dois endereços de e-mail diferentes. Introduza um endereço de email válido nos dois campos fornecidos");
...
define("LAN_SIGNUP_42", "Houve um problema, o e-mail de registo não foi enviado, por favor, entre em contacto com o administrador do site.");
define("LAN_SIGNUP_43", "E-mail enviado");
define("LAN_SIGNUP_44", "E-mail de activação enviado para:");
define("LAN_SIGNUP_45", "Por favor, verifique sua caixa de entrada.");
define("LAN_SIGNUP_47", "Reenviar Email de activação");
define("LAN_SIGNUP_48", "Nome de utilizador ou E-mail");
define("LAN_SIGNUP_49", "Se você se registou com o endereço de e-mail errado, bem como preenchendo na caixa acima, digite um novo endereço de e-mail e sua senha aqui:");
...
define("LAN_SIGNUP_63", "Reenviar e-mail solicitando de redefinição de senha");
...
define("LAN_SIGNUP_72", "Obrigado por inscrever-se na [sitename]! Enviamos mesmo agora um e-mail de confirmação para [email]. Por favor clique no link de confirmação no email para completar o seu registo e activar sua conta.");
...
define("LAN_SIGNUP_115", "Pré visualizar email de activação");
...
define("LAN_SIGNUP_119", "Não enviar email");
define("LAN_SIGNUP_120", "OU");
define("LAN_SIGNUP_121", "Use um endereço de email diferente");
